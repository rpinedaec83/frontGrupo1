    ...
    window.fetch = function (url, opts) {
        return new Promise((resolve, reject) => {
            ...
            function authenticate() {
                ...
                if (!user) return error('Nombre de Usuario o  password es incorrecto');
            ...
            function register() {
                ...
                if (users.find(x => x.username === user.username)) {
                    return error('Username "' + user.username + '" ya esta Elegido')
                }
            ...
            function updateUser() {
                ...
                if (params.username !== user.username && users.find(x => x.username === params.username)) {
                    return error('Username "' + params.username + '" ya esta en Uso')
                }
